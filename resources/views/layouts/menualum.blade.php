                        ...
                        <ul class=" nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                            ...
                            <li class="nav-item">
                                <a href="{{ route('alumno.show', ['alumno' => Auth::user()->id ])}}"
                                    class="{{ Request::path() === 'alumno.show', ['alumno' => Auth::user()->id ] ? 'nav-link active' : 'nav-link' }}">
                            ...
                            <li class="nav-item">
                                <a href="{{route('alumno.proyeccion', ['alumno' => Auth::user()->id ])}}"
                                    class="{{ Request::path() === 'alumno.proyeccion', ['alumno' => Auth::user()->id ] ? 'nav-link active' : 'nav-link' }}">
